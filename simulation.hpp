...
void runSimulation(int numTicks, MarketTick& tick, std::vector<Bot*>& bots, std::vector<std::vector<double>>& botHistory, std::vector<double>& marketHistory, std::mt19937& g);
